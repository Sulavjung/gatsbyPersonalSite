  ...
  return (
	...
	<Navbar />
		...
		<div className='container py-4 d-flex justify-content-between'>
			...
			<img className="rounded-circle my-2" src={profile} alt="Profile" height="37px" width="auto" />
		</div>

		{/* Short Description of the Blog. */}
		<div className="container mb-5">
			<p className='fs-5 py-1 mb-1'>Discover the power of learning, creation and inspiration with topics related to programming.</p>
			<p className='fs-5 py-1 mb-1'>Help yourself with the topics that you want to dive into. Topics are seperated with classes.</p>
