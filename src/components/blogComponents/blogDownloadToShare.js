...
const DownloadBlogToShare = ({
  ...
  if (coverImage !== "NONE") {
    img = require(`../../content/blogPost/Images/${coverImage}`)
  }

  return (
    <div className="popupDownload">
      <div className="popupContent">
        <button onClick={() => setShowDownloadPopup(false)} class="close">
          &times;
        </button>
        <div className="storySizeStyle" id="blogStory">
          {img ? (
            <img src={img.default} alt={Title} className="imgStyle" />
          ) : (
            <></>
          )}
          ...
          <div className="textContainerStyle">
            <p className="aboveDescription mb-1">
              {author} -{" "}
              <span className="border rounded px-1 fw-bold">
                sulavhamal.com
              </span>
            </p>
            <h2 className="downloadTitleStory fw-bold">{Title}</h2>
            <p className="downloadDescriptionStory fw-bold mb-1">
              {Description}
            </p>
        ...
        <button
          ...
          onClick={() => downloadAsPNG("blogStory", "story")}
        >
          Download Story
        </button>
        ...
        <div className="postSizeStyle" id="blogPost">
          ...
          <div className="textContainerStyle1">
            <p className="aboveDescription mb-1">
              {author} -{" "}
              <span className="border rounded fw-bold px-1">
                sulavhamal.com
              </span>
            </p>
        ...
        <button
          className="downloadButton"
          onClick={() => downloadAsPNG("blogPost", "post")}
        >
          Download Post
        </button>
      </div>
