...
tags:
  - Interview
Description: 300+ Questions on React concepts.
...
442. ### What are the differences between pure and impure functions??     Some of the major differences between pure and impure function are as below,
...
445. ### What is referential transparency??     An expression in javascript that can be replaced by its value without affecting the behaviour of the program is called referential transparency. Pure functions are referentially transparent.
